...
config.General.requestName = "CMSSW_7_6_1_PCC_ZeroBias5"
...
#config.JobType.pyCfgParams = ['datasetName=/ZeroBias5/Run2015E-PromptReco-v1/RECO', 'globalTag=74X_mcRun2_asymptotic_v2', 'processType=data']
#config.JobType.sendPythonFolder = True

config.section_("Data")
config.Data.inputDataset = "/ZeroBias5/Run2015E-PromptReco-v1/RECO"

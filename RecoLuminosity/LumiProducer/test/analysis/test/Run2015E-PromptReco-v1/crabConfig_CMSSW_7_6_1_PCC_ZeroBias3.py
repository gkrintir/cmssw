...
config.General.requestName = "CMSSW_7_6_1_PCC_ZeroBias3"
...
#config.JobType.pyCfgParams = ['datasetName=/ZeroBias3/Run2015E-PromptReco-v1/RECO', 'globalTag=74X_mcRun2_asymptotic_v2', 'processType=data']
#config.JobType.sendPythonFolder = True

config.section_("Data")
config.Data.inputDataset = "/ZeroBias3/Run2015E-PromptReco-v1/RECO"
...
config.Data.outLFNDirBase = "/store/user/gkrintir/testLUMI"

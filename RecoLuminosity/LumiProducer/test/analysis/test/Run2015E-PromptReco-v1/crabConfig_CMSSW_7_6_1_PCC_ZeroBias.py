...
config.General.requestName = "CMSSW_7_6_1_PCC_ZeroBias"
...
#config.JobType.pyCfgParams = ['datasetName=/ZeroBias/Run2015E-PromptReco-v1/RECO', 'globalTag=74X_mcRun2_asymptotic_v2', 'processType=data']

...
process.alcaPCCEventProducer = cms.EDProducer("AlcaPCCEventProducer",
     pixelClusterLabel = cms.InputTag("siPixelClusters"),
...
process.ALCARECOStreamPromptCalibProdPCC = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ProdPCC_ZeroBias_Event.root'),
    outputCommands = cms.untracked.vstring('drop *', 
...
process.EvFDaqDirector = cms.Service("EvFDaqDirector",
    ...
    runNumber = cms.untracked.uint32(321305),
...
process.ALCARECOStreamPromptCalibProdOutPath = cms.EndPath(process.ALCARECOStreamPromptCalibProdPCC+process.streamLumi)

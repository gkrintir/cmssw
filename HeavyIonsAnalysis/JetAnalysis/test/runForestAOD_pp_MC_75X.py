...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring(
                                "file:/afs/cern.ch/work/g/gkrintir/private/HI/miniAOD/CMSSW_7_5_8_patch3/src/miniAOD-prod_PAT_11.root"
                            )
)
...
process.HiGenParticleAna.genParticleSrc = cms.untracked.InputTag("prunedGenParticles")
process.HiGenParticleAna.doHI = False
process.load('HeavyIonsAnalysis.EventAnalysis.runanalyzer_cff')
process.load("HeavyIonsAnalysis.JetAnalysis.pfcandAnalyzer_pp_cfi")
process.pfcandAnalyzer.skipCharged = False
process.pfcandAnalyzer.pfPtMin = 0
process.pfcandAnalyzer.pfCandidateLabel = cms.InputTag("packedPFCandidates")
process.pfcandAnalyzer.doVS = cms.untracked.bool(False)
process.pfcandAnalyzer.doUEraw_ = cms.untracked.bool(False)
process.pfcandAnalyzer.genLabel = cms.InputTag("prunedGenParticles")
...
process.ggHiNtuplizer.gsfElectronLabel   = cms.InputTag("slimmedElectrons")
process.ggHiNtuplizer.recoPhotonHiIsolationMap = cms.InputTag('photonIsolationHIProducerpp')
process.ggHiNtuplizer.VtxLabel           = cms.InputTag("offlineSlimmedPrimaryVertices")
process.ggHiNtuplizer.particleFlowCollection = cms.InputTag("packedPFCandidates")
process.ggHiNtuplizer.doVsIso            = cms.bool(False)
process.ggHiNtuplizer.doElectronVID      = cms.bool(True)
process.ggHiNtuplizerGED = process.ggHiNtuplizer.clone(recoPhotonSrc = cms.InputTag('slimmedPhotons'),

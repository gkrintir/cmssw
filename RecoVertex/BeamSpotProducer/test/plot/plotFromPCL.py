...
file_DB  = get_files('/afs/cern.ch/work/g/gkrintir/private/testt/CMSSW_9_4_13/src/reference_prompt_BeamSpotObjects_PCL_byLumi_v0_prompt.txt',  prependPath=True)
#file_DB  = get_files('/afs/cern.ch/work/g/gkrintir/private/testt/CMSSW_9_4_13/src/RecoVertex/BeamSpotProducer/test/scan8_imgY_bx51_test__/BeamFit_LumiBased_alcareco_487_487_Run263234.txt', prependPath=True)
#file_DB  = get_files('/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/data/commonValidation/wangx/CMSSW_10_3_1/src/CondTools/BeamSpot/test/reference_prompt_BeamSpotObjects_PCL_byLumi_v0_prompt.txt'             , prependPath=True)
...
variables = [
    ...
    ('sigmaZ'    , 'beam spot #sigma_{z} [cm]',  4.    , 6.    ),
...
for i, histos in enumerate(zip(histosDB)):
    histo1 = drawMyStyle(histos[0],  variables[i], options = 'kBlack '  , byFill = False, byTime = True)
...
#     leg.Draw('same')
    ...
    ROOT.gPad.Update()
    ROOT.gPad.Print('HIRun2015/BS_' + histos[0].GetName() + '_263234.pdf')
